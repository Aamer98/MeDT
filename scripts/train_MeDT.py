...
def train(args):
    ...
    # Experiment name 
    exp_name = f'{args.model_type}v1_ID{args.id}_nLayer{args.n_layer}_nHead{args.n_head}
                    _nEmb{args.n_embd}_LR{args.learningrate}_BS{args.batchsize}_SEED{args.seed}'
